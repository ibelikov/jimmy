...
gearman_schema_path = os.path.join(modules_dir, 'gearman', 'resources', 'schema.yaml')
jenkins_yaml_path = os.path.join(jimmy_dir, 'sample', 'input', 'jenkins.yaml')


class TestGearmanModule(base.TestCase):
    ...
    def test_cli_call(self, mock_subp, mock_modules):
        ...
        mock_subp.assert_called_with(
            ['java',
             ...
             'groovy',
             modules_dir + '/' + 'gearman/resources/jenkins.groovy',
